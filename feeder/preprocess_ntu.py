...
def gendata(dataset_path, out_path, benchmark, part='eval'):
    ...
    index = 0
    for i, (data, motion, label) in enumerate(tqdm(data_loader)):
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--dataset_path', default='/nfs/users/wangkun/datasets/NTU/NTU-RGB-D')
    # parser.add_argument('--out_folder', default='/nfs/users/wangkun/datasets/NTU/NTU-RGB-D/NTU60_frame50')
    # parser.add_argument('--dataset_path', default='/nfs/users/wangkun/datasets/NTU/NTU-RGB-D-61-120')
    # parser.add_argument('--out_folder', default='/nfs/users/wangkun/datasets/NTU/NTU-RGB-D-61-120/NTU_frame50')
    #
    # benchmark = ['xsub', 'xview']
    # part = ['train', 'val']

    parser.add_argument('--dataset_path', default='/nfs/users/wangkun/datasets/NTU/NTU-RGB-D-120')
    parser.add_argument('--out_folder', default='/nfs/users/wangkun/datasets/NTU/NTU-RGB-D-120/NTU120_frame64')
    #
