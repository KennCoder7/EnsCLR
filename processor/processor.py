...
class Processor(IO):
    ...
    def init_environment(self):
        ...
        self.max_epoch = self.arg.num_epoch
    ...
    def load_data(self):
        ...
        if self.arg.train_feeder_args:
            ...
            self.data_loader['train'] = torch.utils.data.DataLoader(
                ...
                shuffle=self.arg.shuffle_train,
    ...
    def start(self):
        ...
        # training phase
        if self.arg.phase == 'train':
            self.max_iter = self.arg.num_epoch * len(self.data_loader['train'])
    ...
    def get_parser(add_help=False):
        ...
        parser.add_argument('--minibatch_size', type=int, default=128, help='training mini batch size')
        ...
        parser.add_argument('--shuffle_train', type=str2bool, default=True, help='shuffle training data or not')
        return parser
