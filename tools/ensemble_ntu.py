...
# joint_path = '/nfs/users/wangkun/slowfast/SklCLR/PARTSCLR/output/ensemble_aimclr/ensemble_aimclr_single_pro_plus_p2/joint_xsub_le_joint1/'
# bone_path = '/nfs/users/wangkun/slowfast/SklCLR/PARTSCLR/output/ensemble_aimclr/ensemble_aimclr_single_pro_plus_p2/bone_xsub_le_bone1/'
# motion_path = '/nfs/users/wangkun/slowfast/SklCLR/PARTSCLR/output/ensemble_aimclr/ensemble_aimclr_single_pro_plus_p2/motion_xsub_le_motion1/'

# joint_path = '/nfs/users/wangkun/slowfast/SklCLR/PARTSCLR/output/ensemble_aimclr/ensemble_aimclr_single_pro_plus_p2/joint_xsub_le_all/'
# bone_path = '/nfs/users/wangkun/slowfast/SklCLR/PARTSCLR/output/ensemble_aimclr/ensemble_aimclr_single_pro_plus_p2/bone_xsub_le_all/'
# motion_path = '/nfs/users/wangkun/slowfast/SklCLR/PARTSCLR/output/ensemble_aimclr/ensemble_aimclr_single_pro_plus_p2/motion_xsub_le_all/'

# joint_path = '/nfs/users/wangkun/slowfast/SklCLR/PARTSCLR/output/ensemble_aimclr/ensemble_aimclr_single_pro/joint_xsub_ennm_le_joint1/'
# bone_path = '/nfs/users/wangkun/slowfast/SklCLR/PARTSCLR/output/ensemble_aimclr/ensemble_aimclr_single_pro/bone_xsub_ennm_le_bone1/'
# motion_path = '/nfs/users/wangkun/slowfast/SklCLR/PARTSCLR/output/ensemble_aimclr/ensemble_aimclr_single_pro/motion_xsub_ennm_le_motion1/'

joint_path = '/nfs/users/wangkun/slowfast/SklCLR/PARTSCLR/output/ensemble_aimclr/ensemble_aimclr_single_pro/joint_xsub_ennm_le_all/'
bone_path = '/nfs/users/wangkun/slowfast/SklCLR/PARTSCLR/output/ensemble_aimclr/ensemble_aimclr_single_pro/bone_xsub_ennm_le_all/'
motion_path = '/nfs/users/wangkun/slowfast/SklCLR/PARTSCLR/output/ensemble_aimclr/ensemble_aimclr_single_pro/motion_xsub_ennm_le_all/'
...
weights = [0.6, 0.6, 0.4]  # joint, bone, motion
...
for i in tqdm(range(len(label[0]))):
    ...
    _, r22 = r2[i]
    _, r33 = r3[i]
    r = r11 * weights[0] + r22 * weights[1] + r33 * weights[2]
    rank_5 = r.argsort()[-5:]
